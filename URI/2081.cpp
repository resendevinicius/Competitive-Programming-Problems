...
struct node{
  pair<int,int> a,b,c;
  int distancia = 0;
  node(const pair<int,int> &a, const pair<int,int> &b, const pair<int,int> &c, int distancia) : a(a), b(b), c(c), distancia(distancia){}
  bool operator < (const node &other) const {
    if(a != other.a) return a < other.a;
    if(b != other.b) return b < other.b;
    if(c != other.b) return c < other.c;
    if(distancia != other.distancia) return distancia < other.distancia;
    return false;
  }
};
map<node,int> memo;
...
int bfs(pair<int,int> &a, pair<int,int> &b, pair<int,int> &c){
  ...
  while(!q.empty()){
    ...
    int distancia = q.front().distancia;
    q.pop();
    ...
    for(int k = 0; k < 4; k++) {
      ...
      if(move.ff && move.ss.ff && move.ss.ss && nR1 != nR2 && nR1 != nR3 && nR2 != nR3){
        node X = node(nR1,nR2,nR3, distancia);
        if(memo.count(X) == 0){
          X.distancia = distancia + 1;
          memo[X] = 1;
          q.push(X);
        }
      } else if(move.ff && move.ss.ff && nR1 != nR2 && nR1 != r3 && nR2 != r3){
        node X = node(nR1, nR2, r3, distancia);
        if(memo.count(X) == 0){
          X.distancia = distancia + 1;
          memo[X] = 1;
          q.push(X);
        ...
        node X = node(nR1, r2, nR3, distancia);
        if(memo.count(X) == 0){
          X.distancia = distancia + 1;
          memo[X] = 1;
          q.push(X);
        ...
        node X = node(r1, nR2, nR3, distancia);
        if(memo.count(X) == 0){
          X.distancia = distancia + 1;
          memo[X] = 1;
          q.push(X);
        ...
        node X = node(nR1, r2, r3, distancia);
        if(memo.count(X) == 0){
          X.distancia = distancia + 1;
          memo[X] = 1;
          q.push(X);
        ...
        node X = node(r1, nR2, r3, distancia);
        if(memo.count(X) == 0){
          X.distancia = distancia + 1;
          memo[X] = 1;
          q.push(X);
        ...
        node X = node(r1,r2, nR3, distancia);
        if(memo.count(X) == 0){
          X.distancia = distancia + 1;
          memo[X] = 1;
          q.push(X);
